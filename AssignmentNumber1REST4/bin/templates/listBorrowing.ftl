					...
					<div class="row">
						<div class="form-group col-md-12">
							<label class="col-md-2 control-lable" for="borrowedDay">Borrowed
								Day</label>
							<div class="col-md-7">
								<input type="datetime" ng-model="ctrl.borrowing.borrowedDay"
									id="borrowedDay" class="username form-control input-sm"
					...
					<div class="row">
						<div class="form-group col-md-12">
							<label class="col-md-2 control-lable" for="reimbursedDay">Reimbursed
								Day</label>
							<div class="col-md-7">
								<input type="datetime" ng-model="ctrl.borrowing.reimbursedDay"
				...
				<table class="table table-hover">
					...
					<tbody>
						<tr ng-repeat="u in ctrl.getAllUsers()">
							...
							<td>{{u.idBook}}</td>
							<td>{{u.idReader}}</td>
							<td><button type="button" ng-click="ctrl.editUser(u.idBorrowing)"
									class="btn btn-success custom-width">Edit</button></td>
							<td><button type="button" ng-click="ctrl.removeUser(u.idBorrowing)"
